...
# balloon on cheap longshot bets. The measured entry/exit price gap is the real
# drag; this is a modest estimate on top. Tune when the real schedule is known.
US_FEE_RATE = 0.01
